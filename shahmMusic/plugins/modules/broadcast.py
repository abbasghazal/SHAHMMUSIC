...
from shahmMusic import app, userbot
...
from shahmMusic.utils.decorators.language import language
from shahmMusic.utils.formatters import alpha_to_int
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from shahmMusic.core.userbot import assistants
