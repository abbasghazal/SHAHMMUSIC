# This code is written by (C) TheTeamshahm bot will send message to log group when someone add
# this bot to new group make sure to star all projects
# Copyright (C) 2021-2022 by shahm_Help@ Github, < TheTeamshahm >.
...
from shahmMusic.utils.database import get_served_chats
