# Copyright (C) 2021-2022 by shahm_Help @ Github, < https://github.com/TheTeamshahm >.
# A Powerful Music Bot Property Of Rocks Indian Largest Chatting Group
# All rights reserved. © Alisha © shahm © Yukki
...
from shahmMusic import Telegram, YouTube, app
from shahmMusic.misc import SUDOERS
from shahmMusic.plugins.play.playlist import del_plist_msg
from shahmMusic.plugins.sudo.sudoers import sudoers_list
...
from shahmMusic.utils.decorators.language import LanguageStart
from shahmMusic.utils.inline import help_pannel, private_panel, start_pannel
from shahmMusic.utils.command import commandpro
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/92f4bd4cdf907505a0549.jpg",
        caption=f"""
[𝙎𝙊𝙐𝙍𝘾𝙀 𝐒𝐇𝐀𝐇𝐌](https://t.me/gh_fu1)
 —————————————
[ 𝐒𝐇𝐀𝐇𝐌](https://t.me/SHAHM4)
 
[𓏺𝐏𝐎𝐓 𖠙 𝙎𝙊𝙐𝙍𝘾𝙀](https://t.me/SHAHM4)
  
[ ⍟𓏺𝙒𝞝𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝐒𝐇𝐀𝐇𝐌](https://t.me/gh_fu1)""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("‹ السورس ›", url=f"https://t.me/gh_fu1")]]
        ),
    )


@app.on_message(commandpro(["/verify", "shahmverification"]) & ~filters.edited)
async def start(client: Client, message: Message):
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 ᴀʟᴇxᴀ ᴄʜᴀᴛ 💮", url=f"https://t.me/shahm_Help")]]
        ),
    )
